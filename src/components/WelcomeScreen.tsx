...
const WelcomeScreen = () => {
  ...
  const subjects = [{
    ...
    topics: "Current Affairs, Facts, Trivia"
  }];
  ...
  return <div className="text-center space-y-8 py-8">
      ...
      <div className="space-y-4">
        ...
        <div>
          <h2 className="text-4xl font-bold bg-gradient-to-r from-green-600 to-blue-600 bg-clip-text text-transparent mb-3">Welcome to Albedo! </h2>
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 max-w-6xl mx-auto">
        {features.map((feature, index) => <Card key={index} className="p-6 bg-white/90 border-2 border-blue-200 hover:shadow-lg hover:border-blue-300">
      ...
      <div className="space-y-6">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 max-w-4xl mx-auto">
          {subjects.map((subject, index) => <Card key={index} className={`p-4 ${subject.color} border-2 border-blue-200 hover:shadow-md`}>
      ...
      <Card className="max-w-4xl mx-auto p-6 bg-gradient-to-r from-green-50 to-blue-50 border-2 border-blue-200">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          {exampleQuestions.map((example, index) => <div key={index} className="bg-white/80 rounded-lg p-4 text-left shadow-sm hover:shadow-md border border-blue-200">
